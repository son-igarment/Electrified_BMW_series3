%% Electrified BMW Series 3 - Internal Permanent Magnet Motor
...
%flux M pu essere calcolato dai dati di targa cio: ke, p
%fluxM=V0/wn=VLL_RMS*sqrt(2/3)/p/w_mecc=ke*sqrt(2/3)/p
%%
%fluxM pu essere calcolato utilizzando una corrente di eccitazione
